const int Espera_Posicionamento=300; //tempo para a garra chegar a posição (duração do movimento)
const int Espera_Garra=150; //tempo para a garra abrir ou fechar (duração do movimento)
