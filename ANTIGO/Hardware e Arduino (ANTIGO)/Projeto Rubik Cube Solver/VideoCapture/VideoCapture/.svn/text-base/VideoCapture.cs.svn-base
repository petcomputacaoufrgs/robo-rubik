...
namespace VideoCapture
{
    ...
    public class VideoCaptureDevice : System.Windows.Forms.UserControl
    {
        ...
        /// <summary>
        /// Starts the connection with the video device.
        /// </summary>
        public void Start()
        {
            this.Start(0);
        ...
        /// Starts the connection with the video device.
        /// </summary>
        /// <param name="FrameNum">The number of the actual frame.</param>
        public void Start(ulong FrameNum)
        {
            ...
            {
                this.Stop();
                throw new InvalidOperationException("An error ocurred while starting the video capture. Check that your webcamera is connected properly and turned on.\r\n\n" + excep.Message);
            }
        }
        ...
        void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ImageCaptured != null)
                {
                    ...
                    if (tempObj.GetDataPresent(DataFormats.Bitmap))
                    {
            ...
            catch (Exception excep)
            {
                ...
                throw new InvalidOperationException("An error ocurred while capturing the video image. The video capture will now be terminated.\r\n\n" + excep.Message);
            }
        }
